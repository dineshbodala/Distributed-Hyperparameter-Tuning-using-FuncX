...
with Executor(endpoint_id=endpoint_id1) as gce1, Executor(endpoint_id=endpoint_id2) as gce2:
    ...
    future1 = gce1.submit(bayesian_opt1)
    future2 = gce1.submit(random_search)
    future3 = gce1.submit(pbtree_hyperparameter_tuning)

    future4 = gce2.submit(optimize_random_forest)
    future5= gce2.submit(hyperband)
